...
var opportunityrepository = new OpportunityRepostory(context);
var opportunityService = new OpportunityService(consoleHelper, opportunityrepository, reposotry);
var opportunityMenu = new OpportunityMenu(opportunityService);
while (true)
{
    ...
    switch (choice)
    {
        ...
        case 2:
           new LeadMenu(leadService).ShowMainMenu();
            break;
        case 3:
           new OpportunityMenu(opportunityService).ShowMainMenu();
            break;
        case 4:
